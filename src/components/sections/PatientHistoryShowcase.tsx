...
export default function PatientHistoryShowcase() {
  const journeyStages = [
    ...
    },
    {
      ...
      desc: "Doctors record symptoms, issue digital prescriptions, and order diagnostic lab panels directly from consultation screens.",
      icon: Stethoscope,
    ...
    },
    {
      ...
      desc: "Automated doctor percentage splits, itemized QR invoices, and complete medical discharge summaries are archived permanently.",
      icon: CheckCircle2,
  ...
  return (
    <section id="records" className="py-20 sm:py-28 bg-white text-slate-900 relative border-t border-slate-200/80 overflow-hidden">
